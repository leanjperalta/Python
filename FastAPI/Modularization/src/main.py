...
from Python.FastAPI.src.routers.movie_router import movie_router
import datetime
...
app.include_router(prefix="/movies", router=movie_router) #llama las rutas Movies a través de movie_router (APIRouter), e indico el prefijo
